...
<script>
    ...
    let form3 = "<div class=\"mb-3\">\n" +
        ...
        "                <input type=\"text\" name=\"facility_free\" class=\"form-control\">\n" +
        "            </div>";

    document.getElementById("results").innerHTML = form1;
    ...
    function showValue() {
        ...
        if (ele == 1) {
            ...
            document.getElementById("results").innerHTML = form2;
        } else {
            document.getElementById("results").innerHTML = form3;
        }
    }
</script>
